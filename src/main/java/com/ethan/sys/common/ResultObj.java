...
public class ResultObj {
    ...
    public static final ResultObj OUTPORT_SUCCESS = new ResultObj(Constast.OK,"出库成功");
    public static final ResultObj OUTPORT_ERROR = new ResultObj(Constast.ERROR,"出库失败");
