package com.ethan.sys.controller;

import cn.hutool.captcha.CaptchaUtil;
import cn.hutool.captcha.LineCaptcha;
import com.ethan.sys.common.ActiverUser;
...
import com.ethan.sys.vo.UserVo;
...
public class LoginController {
    ...
    public ResultObj login(UserVo userVo, String code, HttpSession session){
        ...
        if (code!=null&&sessionCode.equals(code)){
            ...
            AuthenticationToken token = new UsernamePasswordToken(userVo.getLoginname(),userVo.getPassword());
            try {
                //对用户进行认证登录
                subject.login(token);
